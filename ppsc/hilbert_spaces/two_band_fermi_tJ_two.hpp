...
#ifndef _PPSC_HILBERT_SPACE_two_band_fermi_tJ_two_POS_HPP
#define _PPSC_HILBERT_SPACE_two_band_fermi_tJ_two_POS_HPP
...
// -----------------------------------------------------------------------
class two_band_fermi_tJ_two : public hilbert_space_base {
public:
...
std::ostream &operator<<(
  std::ostream &os, two_band_fermi_tJ_two & hilbert) {
