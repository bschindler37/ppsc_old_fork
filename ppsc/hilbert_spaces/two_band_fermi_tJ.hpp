...
#ifndef _PPSC_HILBERT_SPACE_TWO_BAND_FERMI_TJ_HPP
#define _PPSC_HILBERT_SPACE_TWO_BAND_FERMI_TJ_HPP
...
// -----------------------------------------------------------------------
class two_band_fermi_tJ : public hilbert_space_base {
public:
  ...
  void init(void) {
    ...
    sector = 3;
    nstock_[sector][0] = 8;      // Number corresponding to the binary representation of state
    ninv_[8] = 0;                // Index of state in sector
...
std::ostream &operator<<(
  std::ostream &os, two_band_fermi_tJ & hilbert) {
...
// -----------------------------------------------------------------------
#endif // _PPSC_HILBERT_SPACE_TWO_BAND_Tj_HPP
// -----------------------------------------------------------------------
