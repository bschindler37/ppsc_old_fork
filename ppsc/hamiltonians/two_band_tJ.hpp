...
#ifndef _PPSC_HAMILTONIANS_TWO_BAND_TJ_HPP
#define _PPSC_HAMILTONIANS_TWO_BAND_TJ_HPP
...
// -----------------------------------------------------------------------
template<class HILB> class two_band_tJ {

public:

  // ---------------------------------------------------------------------
  two_band_tJ(int nt, HILB & hilbert_space) :
    nt(nt),
...
#endif // _PPSC_HAMILTONIANS_TWO_BAND_TJ_HPP
