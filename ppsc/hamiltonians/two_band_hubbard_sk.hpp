...
// -----------------------------------------------------------------------
template<class HILB> class two_band_hubbard_sk {

public:

  // ---------------------------------------------------------------------
  two_band_hubbard_sk(int nt, HILB & hilbert_space) :
    nt(nt),
    ...
    pair_hop = c2uc * c2dc * c1ua * c1da + c1dc * c1uc * c2da * c2ua;
    spin_flip =  c1dc * c2uc * c2da * c1ua  + c1uc * c2dc * c2ua * c1da;
  ...
  operator_type densdens_intraband, densdens_interband, densdens_interband_equalspin, pair_hop, spin_flip;
};
