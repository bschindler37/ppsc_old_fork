...
public:
  ...
  operator_type cua, cuc, cda, cdc, nu, nd, n, Q;
};
...
ppsc::pp_ints_type get_pp_ints(ppsc::gf_type & Delta,
  ...
  pp_ints.push_back(ppsc::pp_int_type(Delta,    cuc, cua, fermion, fwd));
  pp_ints.push_back(ppsc::pp_int_type(Delta_cc, cua, cuc, fermion, bwd));
  pp_ints.push_back(ppsc::pp_int_type(Delta,    cdc, cda, fermion, fwd));
  pp_ints.push_back(ppsc::pp_int_type(Delta_cc, cda, cdc, fermion, bwd));
